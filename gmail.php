...
$mail->AltBody = 'เพียง 10 โรงแรมๆ ละ 1 ท่าน (ไม่เสียค่าใช้จ่ายใดๆ ทั้งสิ้น) เตรียมความพร้อมในการตอนรับคู่แต่งงานชาวอินเดีย ภายในวันที่ 14 มีนาคม 2560 ไม่เกิน 12.00 น. mod ['.$mod."] div [".$div."]";
...
echo "Message sent! ". $ccc ." size ".sizeof($bbb);
